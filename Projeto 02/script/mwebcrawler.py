...
class Cursos:
    ...
    def curriculo(curso, nivel=Nivel.GRADUACAO, verbose=False):
        ...
        try:
            ...
            obr_e_opts = busca(OBR_OPT, pagina_html.decode('utf-8'))
    ...
    def fluxo(habilitacao, nivel=Nivel.GRADUACAO, verbose=False):
        ...
        try:
            ...
            oferta = busca(PERIODO, pagina_html.decode('utf-8'))
    ...
    def relacao(nivel=Nivel.GRADUACAO, campus=Campus.DARCY_RIBEIRO,
        ...
        try:
            ...
            cursos_existentes = busca(CURSOS, pagina_html.decode('utf-8'))
...
class Disciplina:
    ...
    def pre_requisitos(disciplina, nivel=Nivel.GRADUACAO, verbose=False):
        ...
        try:
            ...
            requisitos = busca(DISCIPLINAS, pagina_html.decode('utf-8'))
